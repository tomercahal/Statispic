...
class Client(object):
    ...
    def __init__(self):
        ...
        self.dir_photos_taken = "D:/Statispic/Photos"  # Have to change to be where the user selected from
        self.statispic_favicon = "D:/Statispic/favicon.ico"  # Where the favicon is saved
        self.encrypt_key_path = "D:/Statispic/Server_and_client/key.key"  # Where the key is located at
